    ...
    <View style={styles.content}>
      <View style={styles.header}>
        ...
        >
          ...
          >
            <Text style={subPrayers ? { color: '#C8C8C8' } : { color: '#72A8BC' }}>MY PRAYERS</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Text style={subPrayers ? { color: '#72A8BC' } : { color: '#C8C8C8' }}>SUBSCRIBED</Text>
            <Text
              style={{
                marginLeft: 2,
                width: 16,
      ...
      <View style={subPrayers ? {} : { display: 'none' }}>
        <ScrollView>
          {prayersNotChecked.map((prayer) => {
            return (
              <Prayer label={prayer.title} idPrayer={prayer.id} key={prayer.id} isChecked={false} />
            );
          })}
          <View style={checkedPrayers ? styles.hideCheckTextContain : styles.showCheckTextContain}>
            <TouchableOpacity
              onPress={() => {
                handleViewCheck();
              }}
